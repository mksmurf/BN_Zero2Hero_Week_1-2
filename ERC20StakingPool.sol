...
//声明接口，之后导入 openzeppelin类库要使用的类到本文件*
interface IERC20 {
    /**
...
contract LPTokenPool is LPTokenWrapper, IRewardDistributionRecipient {
    ...
    /// @notice 结束时间 设定为3月27号0点GMT
    uint256 public periodFinish = 1679875200;
    /// @notice 每秒奖励数量
    uint256 public rewardRate = 10000000000;
    /// @notice 最后更新时间
